...
class LANG(object):
    ...
    START_TEXT = """
    <B>hey,{}\n\n</b>ɪ ᴀᴍ ᴀ sᴛʀᴀɪɢʜᴛғᴏʀᴡᴀʀᴅ ғɪʟᴇ-ᴛᴏ-ʟɪɴᴋ ʙᴏᴛ ᴛʜᴀᴛ ᴀʟʟᴏᴡs ʏᴏᴜ ᴛᴏ sᴛʀᴇᴀᴍ ᴏʀ ϙᴜɪᴄᴋʟʏ ᴅᴏᴡɴʟᴏᴀᴅ ᴀɴʏ ᴠɪᴅᴇᴏ ғɪʟᴇ.\n\nᴍᴀᴅᴇ ʙʏ:<a href='https://telegram.me/Cinearcade'> ᴄɪɴᴇᴀʀᴄᴀᴅᴇ</a>"""
